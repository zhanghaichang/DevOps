...
*   [使用 Docker / Docker Compose 部署](/zh-cn/docs/ops/deploy-by-docker.html)
    
*   [使用 Kubernetes 部署](/zh-cn/docs/ops/deploy-by-kubernetes.html)
    
*   [使用 Helm 部署](/zh-cn/docs/ops/deploy-by-helm.html)
